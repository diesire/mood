        ...
        while (html) {
            ...
            if (!stack.last() || !specialElements[stack.last()]) {
                ...
                if (html.indexOf("<!--") === 0) {
                    ...
                    if (index >= 0) {
                        if (handler.comment) handler.comment(html.substring(4,
                                index));
            ...
            start: function(tag, attrs, unary) {
                ...
                if (!ignore && validElements[tag] == true) {
                    ...
                    angular.forEach(attrs, function(value, key) {
                        ...
                        if (validAttrs[lkey] == true && (uriAttrs[lkey] !==
                            true || value.match(URI_REGEXP))) {
                            out(' ');
                            out(key);
                            out('="');
    ...
    angular.module('ngSanitize').directive('ngBindHtml', ['$sanitize',
        function($sanitize) {
            return function(scope, element, attr) {
                ...
                scope.$watch(attr.ngBindHtml, function ngBindHtmlWatchAction(
                    value) {
