 ...
 */
    ...
    function JstdPlugin() {
         ...
         */
        this.runTestConfiguration = function(configuration, onTestDone,
            onAllTestsComplete) {
        ...
        this.getTestRunsConfigurationFor = function(testCaseInfos, expressions,
    ...
    initScenarioAdapter(window.jstestdriver, angular.scenario.setUpAndRun,
        window.jstdScenarioAdapter);
})(window);
