...
(function() {
    ...
    function configurePackageDir(pkgs, currentPackages, dir) {
        ...
        (pkgObj = currentPackages[i]); i++) {
            ...
            if (dir && (!location || (location.indexOf("/") !== 0 && location.indexOf(
                ":") === -1))) {
    ...
    function newContext(contextName) {
            ...
            if (name) {
                ...
                if (!url) {
                    ...
                    if (req.toModuleUrl) {
                        ...
                        //like Node.
                        url = req.toModuleUrl(context, normalizedName,
                            parentModuleMap);
                    } else {
                        url = context.nameToUrl(normalizedName, null,
                            parentModuleMap);
                    }
        ...
        function makeRequire(relModuleMap, enableBuildCallback) {
            var modRequire = makeContextModuleFunc(context.require,
                relModuleMap, enableBuildCallback);

            mixin(modRequire, {
                nameToUrl: makeContextModuleFunc(context.nameToUrl,
                    relModuleMap),
                toUrl: makeContextModuleFunc(context.toUrl, relModuleMap),
                defined: makeContextModuleFunc(context.requireDefined,
                    relModuleMap),
                specified: makeContextModuleFunc(context.requireSpecified,
                    relModuleMap),
                ready: req.ready,
        ...
        function updateNormalizedNames(pluginName) {
            ...
            if (maps) {
                ...
                (oldModuleMap = maps[i]); i++) {
                    ...
                    moduleMap = makeModuleMap(oldModuleMap.originalName,
                    ...
                    if (fullName !== oldFullName) {
                        ...
                        if (existingCallbacks) {
                            managerCallbacks[fullName] = existingCallbacks.concat(
                                callbacks);
                        } else {
        ...
        function execManager(manager) {
            ...
            if (cb && isFunction(cb)) {
                ...
                try {
                    ret = req.execCb(fullName, manager.callback, args, defined[
                        fullName]);
                } catch (e) {
                    err = e;
                }
                ...
                if (fullName) {
                    ...
                    if (manager.cjsModule && manager.cjsModule.exports !==
                        undefined) {
        ...
        function main(inName, depArray, callback, relModuleMap) {
            ...
            for (i = 0; i < depArray.length; i++) {
                ...
                if (depArg) {
                    ...
                    depArg = makeModuleMap(depArg, (name ? moduleMap :
                        relModuleMap));
                    ...
                    if (depName === "require") {
                        ...
                        manager.cjsModule = cjsMod = manager.deps[depName] = {
                            id: name,
                            uri: name ? context.nameToUrl(name, null,
                                relModuleMap) : undefined,
        ...
        jQueryCheck = function(jqCandidate) {
            if (!context.jQuery) {
                var $ = jqCandidate || (typeof jQuery !== "undefined" ? jQuery :
                    null);
            ...
            for (i = 0; i < depArray.length; i++) {
                ...
                if (depName) {
                    if (!manager.deps[depName] && waiting[depName]) {
                        manager.onDep(depName, forceExec(waiting[depName],
                            traced));
                    }
                }
            }
        ...
        function callPlugin(pluginName, dep) {
            ...
            plugins[pluginName].load(name, makeRequire(dep.parentMap, true),
                load, config);
        }
                ...
                if (defined[pluginName]) {
                    ...
                    if (!pluginsQueue[pluginName]) {
                        ...
                        (managerCallbacks[pluginName] ||
                            ...
                            onDep: function(name, value) {
                                if (name === pluginName) {
                                    var i, oldModuleMap, ary = pluginsQueue[
                                            pluginName];
                                    ...
                                    for (i = 0; i < ary.length; i++) {
                                        ...
                                        callPlugin(pluginName,
                                            makeModuleMap(oldModuleMap.originalName,
                                            oldModuleMap.parentMap));
                                    }
        ...
        resume = function() {
            ...
            while (defQueue.length) {
                args = defQueue.shift();
                if (args[0] === null) {
                    return req.onError(makeError('mismatch',
        ...
        context = {
                ...
                if (packagePaths || cfg.packages) {
                    ...
                    if (packagePaths) {
                        for (prop in packagePaths) {
                            if (!(prop in empty)) {
                                configurePackageDir(pkgs, packagePaths[prop],
                                    prop);
                            }
                        }
                    }
            ...
            requireDefined: function(moduleName, relModuleMap) {
                return makeModuleMap(moduleName, relModuleMap).fullName in
                    defined;
            },
            ...
            require: function(deps, callback, relModuleMap) {
                ...
                if (typeof deps === "string") {
                    ...
                    if (!(fullName in defined)) {
                        return req.onError(makeError("notloaded",
                            "Module name '" +
                            moduleMap.fullName +
            ...
            completeLoad: function(moduleName) {
                ...
                if (args) {
                    ...
                    callDefMain([moduleName, [],
                        moduleName === "jquery" && typeof jQuery !==
                            "undefined" ? function() {
                            return jQuery;
                        } : null
                    ]);
    ...
    define = req.def = function(name, deps, callback) {
        ...
        if (useInteractive) {
            ...
            if (!node) {
                return req.onError(makeError("interactive",
                    "No matching script interactive for " + callback));
            }
            if (!name) {
