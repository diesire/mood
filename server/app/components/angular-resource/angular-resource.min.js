...
(function(C, d, w) {
    'use strict';
    d.module("ngResource", ["ng"]).factory("$resource", ["$http", "$parse",
        function(x, y) {
            function s(b, e) {
                return encodeURIComponent(b).replace(/%40/gi, "@").replace(
            ...
            function u(b, e, a) {
                function f(m, a) {
                    ...
                    h(a, function(a, z) {
                        var c;
                        a.charAt && a.charAt(0) == "@" ? (c = a.substr(1), c =
                            y(c)(m)) : c = a;
                        b[z] = c
                    });
                    return b
                ...
                h(a, function(a, b) {
                    ...
                    var e = a.method == "POST" || a.method == "PUT" || a.method ==
                        "PATCH";
                    g[b] = function(b, c, d, B) {
                        ...
                        var n = this instanceof g ? this : a.isArray ? [] : new g(
                            i);
                        x({
                            method: a.method,
            ...
            t.prototype = {
                url: function(b) {
                    ...
                    h(this.urlParams, function(h, c) {
                        ...
                        d.isDefined(f) && f !== null ? (g = s(f, !0).replace(
                            /%26/gi, "&").replace(/%3D/gi,
                            "=").replace(/%2B/gi, "+"), a = a.replace(RegExp(
                            ":" + c + "(\\W)", "g"), g + "$1")) : a = a.replace(
                            RegExp("(/?):" + c + "(\\W)", "g"), function(a, b,
                            c) {
