    ...
    for (property in b) {
        ...
        if (!this.equals_(a[property], b[property], mismatchKeys,
            ...
            mismatchValues.push("'" + property + "' was '" + (b[property] ?
                jasmine.util.htmlEscape(b[property].toString()) : b[property]) +
                "' in expected, but was '" + (a[property] ? jasmine.util.htmlEscape(
...
jasmine.JsApiReporter.prototype.summarizeResult_ = function(result) {
    ...
    for (var messageIndex = 0; messageIndex < messagesLength; messageIndex++) {
        ...
        summaryMessages.push({
            ...
            trace: {
                stack: resultMessage.passed && !resultMessage.passed() ? resultMessage
                    .trace.stack : jasmine.undefined
            }
        });
    }
    ...
    this.message = function() {
        if (this.actual.callCount === 0) {
            ...
            return [
                "Expected spy " + this.actual.identity +
                " to have been called with " + jasmine.pp(expectedArgs) +
                " but was called with " + jasmine.pp(this.actual.argsForCall),
                "Expected spy " + this.actual.identity +
                " not to have been called with " + jasmine.pp(expectedArgs) +
                " but was called with " + jasmine.pp(this.actual.argsForCall)];
        }
