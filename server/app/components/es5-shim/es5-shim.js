...
(function(definition) {
            ...
            Array.prototype.splice = function(start, deleteCount) {
                if (!arguments.length) {
                    ...
                    return array_splice.apply(this, [
                        ...
                        deleteCount === void 0 ? (this.length - start) :
                            deleteCount
            ...
            Array.prototype.splice = function(start, deleteCount) {
                ...
                if (addElementsCount > 0) {
                    ...
                    args.push.apply(args, _Array_slice_.call(this, start +
                        deleteCount, this.length)); // right part
                ...
                if (match) {
                    ...
                    day > -1 &&
                        ...
                        (result + minute + minuteOffset * signOffset) * 60 +
                            second) * 1000 + millisecond + offset;
    ...
    if (!Number.prototype.toFixed || (0.00008).toFixed(3) !== '0.000' || (0.9).toFixed(
        0) === '0' || (1.255).toFixed(2) !== '1.25' || (1000000000000000128).toFixed(
            ...
            Number.prototype.toFixed = function(fractionDigits) {
                ...
                if (x > 1e-21) {
                    ...
                    if (e > 0) {
                        ...
                        multiply(0, z);
                        multiply(1 << (-e), 0);
                        m = toString() + '0.00000000000000000000'.slice(2, 2 +
                            f);
                    }
                }
