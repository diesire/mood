...
(function(exports) {
    ...
    //db.once('open', console.log.bind(console, 'db successfully opened'));
...
(function(exports) {
    exports.ratingStrategy = {
        // tweet mean = words mean; stemm selection, first one
