...
exports['test'] = {
    ...
    'Tokenize simple text': function (test) {
        ...
        test.expect(1);
        test.deepEqual(mood.tools.tokenizer(helloWorld), ['Hola', 'mundo'], 'should be [Hola, mundo]');
        test.done();
    },
    ...
    'Stemmize simple text': function (test) {
        ...
        test.expect(1);
        test.deepEqual(mood.tools.stemmer(helloWorld), ['adi', 'mundo', 'cruel'], 'should be [adi, mundo, cruel]');
        test.done();
    },
    
    'Detect spanish text': function (test) {
        var text = 'En un lugar de la Mancha de cuyo nombre no quiero acordarme';
